...
[![Build Status](https://travis-ci.com/biologger/speciesprimer.svg?branch=p3konly)](https://travis-ci.com/biologger/speciesprimer)
...
[![codecov](https://codecov.io/gh/biologger/speciesprimer/branch/p3konly/graph/badge.svg)](https://codecov.io/gh/biologger/speciesprimer)
...
New in SpeciesPrimer v3
* No scripts using python2
* MFEPrimer-3.x

## Contents
* [Hardware recommendations](https://github.com/biologger/speciesprimer/tree/p3konly#hardware-recommendations)
* [quick start (Ubuntu 16.04)](https://github.com/biologger/speciesprimer/tree/p3konly#quick-start-ubuntu-1604)
* [Introduction](https://github.com/biologger/speciesprimer/tree/p3konly#introduction)
	* [Pipeline workflow and tools](https://github.com/biologger/speciesprimer/tree/p3konly#pipeline-workflow-and-tools)
	* [Command line options](https://github.com/biologger/speciesprimer/tree/p3konly#run-settings)
* [Citation](https://github.com/biologger/speciesprimer/tree/p3konly#citation)

## Docs
* [Pipeline and Docker tutorial](https://github.com/biologger/speciesprimer/tree/p3konly/docs/tutorial.md)
* [Advanced command line usage](https://github.com/biologger/speciesprimer/blob/p3konly/docs/cmdlineonly.md)
* [Pipeline setup](https://github.com/biologger/speciesprimer/tree/p3konly/docs/pipelinesetup.md)
* [Primerdesign](https://github.com/biologger/speciesprimer/tree/p3konly/docs/primerdesign.md)
* [Troubleshooting](https://github.com/biologger/speciesprimer/tree/p3konly/docs/troubleshooting.md)
* [Custom BLAST DB tutorial](https://github.com/biologger/speciesprimer/tree/p3konly/docs/customdbtutorial.md)
* [More troubleshooting (Docker)](https://github.com/biologger/speciesprimer/tree/p3konly/docs/dockertroubleshooting.md)
* [Docker and proxy settings](https://github.com/biologger/speciesprimer/tree/p3konly/docs/dockerproxy.md)
...
For more information and advanced settings see [Advanced command line usage](https://github.com/biologger/speciesprimer/blob/p3konly/docs/cmdlineonly.md)
...
|- quality control|BLAST+, Mfold, MFEPrimer 3.1|[Altschul et al. 1990](https://doi.org/10.1016/s0022-2836%2805%2980360-2); [Zuker et al. 1999](https://doi.org/10.1007/978-94-011-4485-8_2); [Qu et al. 2012](https://doi.org/10.1093/nar/gks552)|
